  ...
  var t = {},
    ...
    r = function() {
        ...
        return e.on = function (t, e, s) {
            ...
            for (let s in e = e.split(" ")) this.on(e[s], (function (e) {
                const s = e.target;
                s.matches(t) && i.call(s, e)
            }))
        }, e.css = function (t) {
            for (let e in t) this.selector.style[e] = t[e];
            return this
        }, e.text = function (t) {
  ...
  var d = function(t, e, i) {
    ...
    const v = function () {
            ...
            return e.createElement = function (t) {
                ...
                if (f.isObj(t))
                    for (let i in t) this.applyAttr(i, t[i]);
    ...
    const x = function () {
        ...
        M = function (t) {
            function e(e) {
                ...
                const c = i.shape.getBBox(),
                    u = i.getLabelText(a, o);
                if (o && u) {
                    const p = i.getLabelOffsets(a);
    ...
    const O = function () {
            ...
            return t.prototype.render = function () {
                let t, e, i;
                const s = this._series.scale.getTicks(),
                    a = f.createElement("div", "jvm-legend-inner");
                if (this._body.innderHTML = "", this._options.title) {
                    const r = f.createElement("div", "jvm-legend-title", this._options.title);
                ...
                for (let n = 0; n < s.length; n++) {
                    ...
                    const o = f.createElement("div", "jvm-legend-tick-text", i);
        ...
        C = function () {
            ...
            return e.getValue = function (t) {
                ...
                const t = [];
                for (let e in this._scale) t.push({
                    label: e,
                    value: this._scale[e]
                });
                return t
        ...
        X = function () {
            ...
            return e.setValues = function (t) {
                const e = {};
                for (let i in t) t[i] && (e[i] = this.scale.getValue(t[i]));
                this.setAttributes(e)
            }, e.setAttributes = function (t) {
                for (let e in t) this._elements[e] && this._elements[e].element.setStyle(this.config.attribute, t[e])
            }, e.clear = function () {
                let t;
                const e = {};
    ...
    const L = function () {
        ...
        return e.setMinMaxValues = function (t) {
            for (let e in this.min = Number.MAX_VALUE, this.max = 0, t) (e = parseFloat(t[e])) > this.max && (this.max = e), e < this.min && (this.min = e)
        }, e.visualize = function () {
            let t;
            const e = {};
            for (let i in this._values) t = parseFloat(this._values[i]), isNaN(t) || (e[i] = this.getValue(t));
            this.setAttributes(e)
        }, e.setAttributes = function (t) {
            for (let e in t) this._map.regions[e] && this._map.regions[e].element.setStyle("fill", t[e])
    ...
    var T = Object.freeze({
            ...
            handleContainerEvents: function () {
                ...
                this.params.draggable && (this.container.on("mousemove", (function (i) {
                    ...
                    const s = i.container.selector.getBoundingClientRect(),
              ...
              h = function (h) {
                  ...
                  if ("touchstart" == h.type && (n = 0), 1 == d.length) 1 == n && (u = o.transX, p = o.transY, o.transX -= (i - d[0].pageX) / o.scale, o.transY -= (s - d[0].pageY) / o.scale, o.tooltip.hide(), o.applyTransform(), u == o.transX && p == o.transY || h.preventDefault()), i = d[0].pageX, s = d[0].pageY;
                      ...
                      if (2 == n) c = Math.sqrt(Math.pow(d[0].pageX - d[1].pageX, 2) + Math.pow(d[0].pageY - d[1].pageY, 2)) / e, o.setScale(t * c, a, r), o.tooltip.hide(), h.preventDefault();
                          ...
                          const f = o.container.selector.getBoundingClientRect();
                          l = {
      ...
      createLines: function(t, e, i) {
          ...
          let a, r = !1,
              n = !1;
          for (let o in this.linesGroup = this.linesGroup || this.canvas.createGroup("jvm-lines-group"), t) {
              const h = t[o];
              for (let l in e) {
                  const c = i ? e[l].config : e[l];
      ...
      createMarkers: function(t, e) {
          let i, s, a, r;
          const n = this;
          for (let o in void 0 === t && (t = {}), void 0 === e && (e = !1), this.markersGroup = this.markersGroup || this.canvas.createGroup("jvm-markers-group"), this.markerLabelsGroup = this.markerLabelsGroup || this.canvas.createGroup("jvm-markers-labels-group"), t) {
      ...
      createTooltip: function() {
          ...
          this.tooltip = f.$(document.body.appendChild(e)), this.container.on("mousemove", (function (i) {
              if ("block" === t.tooltip.selector.style.display) {
                  const s = t.container.selector.querySelector("#jvm-regions-group").getBoundingClientRect(),
      ...
      createSeries: function() {
          for (let t in this.series = {
              markers: [],
              regions: []
          }, this.params.series)
              for (let e = 0; e < this.params.series[t].length; e++) this.series[t][e] = new X(this.params.series[t][e], this[t], this)
      },
      ...
      setFocus: function(t) {
          ...
          if (t.region ? s.push(t.region) : t.regions && (s = t.regions), s.length) return s.forEach((function (t) {
              if (e.regions[t]) {
                  const s = e.regions[t].element.shape.getBBox();
                  s && (i = void 0 === i ? s : {
                      x: Math.min(i.x, s.x),
                      y: Math.min(i.y, s.y),
      ...
      resize: function() {
          const t = this.baseScale;
          this.width / this.height > this.defaultWidth / this.defaultHeight ? (this.baseScale = this.height / this.defaultHeight, this.baseTransX = Math.abs(this.width - this.defaultWidth * this.baseScale) / (2 * this.baseScale)) : (this.baseScale = this.width / this.defaultWidth, this.baseTransY = Math.abs(this.height - this.defaultHeight * this.baseScale) / (2 * this.baseScale)), this.scale *= this.baseScale / t, this.transX *= this.baseScale / t, this.transY *= this.baseScale / t
      },
      setScale: function(t, e, i, s, a) {
          let r, n, o, h, l, c, u, p, d, f;
          const m = this;
          let g = 0;
          const v = Math.abs(Math.round(60 * (t - this.scale) / Math.max(t, this.scale)));
      ...
      coordsToPoint: function(t, e) {
          let i, s, a;
          const r = z.maps[this.params.map].projection,
              n = r.centralMeridian;
      ...
      getInsetForPoint: function(t, e) {
          let i, s;
          const a = z.maps[this.params.map].insets;
      ...
      repositionMarkers: function() {
          let t;
          for (let e in this.markers) !1 !== (t = this.getMarkerPosition(this.markers[e].config)) && this.markers[e].element.setStyle({
              cx: t.x,
              cy: t.y
          })
      },
      repositionLabels: function() {
          ...
          if (t) {
              if (t.regions)
                  for (let e in this.regions) this.regions[e].element.updateLabelPosition();
              if (t.markers)
                  for (let i in this.markers) this.markers[i].element.updateLabelPosition()
          }
      },
    ...
    z = function() {
      ...
      return e.init = function(t) {
          ...
          for (let i in A) A[i] === t && f.isFunc(this.params[i]) && this.params[i].apply(this, e)
        ...
        void 0 === i && (i = {}), this.createLines([{
          ...
          for (let t in this.series)
              for (let e = 0; e < this.series[t].length; e++) this.series[t][e].clear();
