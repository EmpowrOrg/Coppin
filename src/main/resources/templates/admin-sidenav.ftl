<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 fixed-start ps" style="background: white"
    ...
    <div class="sidenav-header">
        <a class="text-center justify-content-center align-items-center align-content-center align-self-center"
           target="_blank">
            <h3 class="ms-1 font-weight-bold">{} Admin</h3>
        </a>
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link" href="/admin/ai">
                    ...
                    <span class="nav-link-text ms-1">Ai Settings</span>
                </a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item mt-3">
                <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-8"></h6>
            </li>
            <li class="nav-item">
